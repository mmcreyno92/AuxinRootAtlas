...
#Extract gene ids from the sets, use filter to pick sets of interest to extract, example given is for 3 samples EZ, C, and S tissue auxin 120 min treatment DE up
